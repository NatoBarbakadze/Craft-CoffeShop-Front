...
function CoffeeDisplay() {
  const { response: coffees, loading, error } = useFetch({
          ...
          <HeaderMini>
            ...
            <CoffeeGrid>
              {coffees?.map((coffee) => {
                ...
                return (
                  <CoffeeCard key={coffee.id} onClick={() => navigate(`/coffees/${coffee.id}`)}>
                    <CoffeeImage
                      src={coffeeImg}
                      alt={coffee.data?.title || coffee.name}
                    />
                    <CoffeeInfoWrapper>
                      <CoffeeText>
                        <h4>{coffee.data?.title || coffee.name}</h4>
